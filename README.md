...
This Docker image runs automated Hodgkin lymphoma segmentation on baseline & interim PET/CT scans using our proposed Longitudinally-Aware Segmentation Network (LAS-Net)
